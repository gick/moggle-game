<template>
  <v-ons-page>
    <v-ons-toolbar>
      ...
      <div  class="left">
        <v-ons-back-button v-if="currentPage>0" @click.prevent="back"></v-ons-back-button>
      </div>
      ...
      >
        <v-ons-list>
          ...
          >
            ...
            <div class="right" v-if="page.label=='Inventaire'"><Badge style="top:15px" :value="badgeValue"></Badge></div>
          </v-ons-list-item>
        </v-ons-list>
      </v-ons-popover>
    </v-ons-toolbar>
